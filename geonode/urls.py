...
urlpatterns = patterns('',
                       ...
                       url(r'^register/$',
                           'geonode.datarequests.views.register', name='register'),
                       ...
                       # Geocoding
                       (r'^geocoding/', include('geonode.arealocate.urls',
                                                namespace='arealocate')),

                       # Data Request Profiles
                       (r'^requests/', include('geonode.datarequests.urls',
                       ...
                       # CephGeo
                       url(r'^ceph/',
                           include("geonode.cephgeo.urls")),

                       # Automation
                       url(r'^automation/', include('geonode.automation.urls',
