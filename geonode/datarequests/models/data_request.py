...
class DataRequest(BaseRequest, StatusModel):
    ...
    The data request model which inherits from BaseRequest and StatusModel
    ...
    The following functions are getter functions for fields that are not included in a data request
        get_first_name
        get_last_name
        get_email
        get_contact_numer
